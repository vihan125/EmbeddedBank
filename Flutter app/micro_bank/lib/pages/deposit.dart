                            ...
                            if (last_id.isEmpty) {
                              await db.execute(
                                  'insert into transactions (account_id,date_time,amount,type)'
                                      'values("$acc_id","$date_time","$amount","Deposit")');
                              ...
                              if (new_id.isNotEmpty) {
                                ...
                                await db.execute(
                                    'insert into makes values("$acc_id","$new_t")');
                                String new_balance = (balance + dAmount)
                                    .toString();
                                await db.rawQuery(
                              ...
                              if (t1.transaction_id + 1 == t2.transaction_id) {
                                ...
                                String new_balance = (balance+dAmount).toString();
